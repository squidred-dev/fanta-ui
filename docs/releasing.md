...
All published packages use the coordinated version `0.4.0` and use exact internal dependencies.
...
[dependencies]
fanta-gpui = "=0.4.0"
gpui = { package = "fanta-gpui-core", version = "=0.4.0" }
gpui-component = { package = "fanta-gpui-components", version = "=0.4.0" }
gpui_platform = { package = "fanta-gpui-gpui-platform", version = "=0.4.0" }
```
...
workspace version (`v0.4.0` for this release).
