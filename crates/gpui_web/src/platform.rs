...
static BUNDLED_FONTS: &[&[u8]] = &[
    include_bytes!("../test_assets/fonts/ibm-plex-sans/IBMPlexSans-Regular.ttf"),
    include_bytes!("../test_assets/fonts/ibm-plex-sans/IBMPlexSans-Italic.ttf"),
    include_bytes!("../test_assets/fonts/ibm-plex-sans/IBMPlexSans-SemiBold.ttf"),
    include_bytes!("../test_assets/fonts/ibm-plex-sans/IBMPlexSans-SemiBoldItalic.ttf"),
    include_bytes!("../test_assets/fonts/lilex/Lilex-Regular.ttf"),
    include_bytes!("../test_assets/fonts/lilex/Lilex-Bold.ttf"),
    include_bytes!("../test_assets/fonts/lilex/Lilex-Italic.ttf"),
    include_bytes!("../test_assets/fonts/lilex/Lilex-BoldItalic.ttf"),
];
