...
pub(crate) fn init(cx: &mut App) {
    cx.bind_keys([
        ...
        KeyBinding::new("b", SelectBrushTool, Some(TOOLBAR_KEY_CONTEXT)),
        KeyBinding::new("e", SelectEraserTool, Some(TOOLBAR_KEY_CONTEXT)),
        KeyBinding::new("m", SelectMarqueeTool, Some(TOOLBAR_KEY_CONTEXT)),
        KeyBinding::new("w", SelectWandTool, Some(TOOLBAR_KEY_CONTEXT)),
