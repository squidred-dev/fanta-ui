...
impl DesignPanelNodeKind {
    ...
    pub const fn lucide_icon(self) -> crate::atoms::LucideIcon {
        use crate::atoms::LucideIcon;
        match self {
            Self::Frame => LucideIcon::Frame,
            Self::Group | Self::TransformGroup => LucideIcon::Group,
            Self::Section => LucideIcon::PanelTop,
            Self::Component => LucideIcon::Component,
            Self::ComponentSet => LucideIcon::LayoutGrid,
            Self::Instance => LucideIcon::Diamond,
            Self::Slot => LucideIcon::PackageOpen,
            Self::Widget => LucideIcon::PanelsTopLeft,
            Self::Text => LucideIcon::TypeIcon,
            Self::TextPath => LucideIcon::Baseline,
            Self::Image => LucideIcon::Image,
            Self::Video => LucideIcon::Video,
            Self::Rectangle => LucideIcon::Square,
            Self::Ellipse => LucideIcon::Circle,
            Self::Polygon => LucideIcon::Pentagon,
            Self::Star => LucideIcon::Star,
            Self::Line => LucideIcon::Slash,
            Self::Arrow => LucideIcon::ArrowUpRight,
            Self::Vector => LucideIcon::Spline,
            Self::BooleanOperation => LucideIcon::Combine,
            Self::Slice => LucideIcon::ScanLine,
            Self::Mask => LucideIcon::Scan,
            Self::Table => LucideIcon::Table2,
            Self::Pen => LucideIcon::PenTool,
            Self::Pencil => LucideIcon::Pencil,
            Self::MultipleSelection => LucideIcon::Copy,
            Self::Other => LucideIcon::Ellipsis,
        }
    }
