...
use gpui::{
    ...
    Styled as _, Window, div, prelude::FluentBuilder as _, px, rgba,
};
use gpui_component::{
...
impl PrototypePanel {
    ...
    fn render_surface_tab(
        ...
        div()
            ...
            .on_action(cx.listener(move |_, _: &ActivateControl, _, cx| {
        ...
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .items_start()
                    .gap(px(16.))
                    .child(div().w(px(16.)).flex_none().text_size(px(18.)).child(glyph))
                    .child(
                        div()
                            .flex_1()
                            .min_w(px(0.))
                ...
                v_flex()
                    ...
                    .child(
                        h_flex()
                            ...
                            .child(self.view_data.device_name.clone())
                            .child(div().flex_1())
                            .child(Icon::new(IconName::ChevronDown).xsmall()),
                    )
                    .child(
